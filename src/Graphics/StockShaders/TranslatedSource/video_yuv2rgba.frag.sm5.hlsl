Texture2D<float4> YSampler : register(t0);
SamplerState _YSampler_sampler : register(s0);
Texture2D<float4> USampler : register(t1);
SamplerState _USampler_sampler : register(s1);
Texture2D<float4> VSampler : register(t2);
SamplerState _VSampler_sampler : register(s2);
